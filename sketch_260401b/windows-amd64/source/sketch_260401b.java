/* autogenerated by Processing revision 1313 on 2026-04-14 */
...
public class sketch_260401b extends PApplet {
...
public void brushButton(int x, int y, int c) {
...
public void canvasButton(int x, int y, int c) {
  if (mouseX > x && mouseX < x+50 && mouseY > y && mouseY < y+50) {
    stroke(255);
...
public void eraserButton(int x, int y) {
...
public void sanicStamp(int x, int y) {
...
public void shadoughStamp(int x, int y) {
...
public void loadButton(int x, int y) {
  if (mouseX > x && mouseX < x + 50 && mouseY > y && mouseY < y + 50) {
    stroke(255);
  } else {
    stroke(0);
  ...
  public void settings() { size(1300, 1000); }

  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--hide-stop", "sketch_260401b" };
    if (passedArgs != null) {
